                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(album.name, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white),),
                          Text(album.artistId, style: TextStyle(fontSize: 18, color: Colors.white),),
                          Text(album.year.toString(), style: TextStyle(fontSize: 18, color: Colors.white),),
                          SizedBox(height: 20),
