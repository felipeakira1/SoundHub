          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 20),
                Text(artista.name, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white),),
                Text("Gênero Musical: ${artista.musicalGenre}", style: TextStyle(fontSize: 18, color: Colors.white),),
                Text("Nascido em: ${artista.birthYear}", style: TextStyle(fontSize: 18, color: Colors.white),),
                SizedBox(height: 20),
                Padding(
                ...
                Padding(
                  ...
                  child: Text(artista.biography, style: TextStyle(fontSize: 16, color: Colors.white), textAlign: TextAlign.justify),
                ),
                SizedBox(height: 20),
